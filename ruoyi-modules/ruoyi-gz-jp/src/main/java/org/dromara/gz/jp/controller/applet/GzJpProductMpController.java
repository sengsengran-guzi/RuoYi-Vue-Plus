 ...
 *
 * <p><b>可见性（AC）</b>：只下发「商品 on_shelf <b>且</b> 所属场生效状态 open」的商品。
 * 已下架商品、未开场（draft）/ 已关场 / end_time 已过的场里的商品，一律查不到。</p>
 *
...
public class GzJpProductMpController {
     ...
     * </pre>
     *
     * <p>场已结束 / 未开场时返回<b>空页</b>（rows=[]，total=0）而非报错 —— mp 进场前已从
     * {@code GET /app/gz/jp/event/{id}} 拿到「该场已结束」的明确信号。</p>
     *
